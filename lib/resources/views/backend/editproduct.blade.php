							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
					                    ...
					                    <img id="avatar" class="thumbnail" width="300px" src="{{asset('lib/storage/app/products/'.$product->prod_image)}}">
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
                                        ...
                                        <select required name="cate" class="form-control">
                                            @foreach($listcate as $cate)
                                                <option value="{{$cate->cate_id}}" @if($product->prod_cate == $cate->cate_id) selected @endif{{$cate->cate_name}}>{{$cate->cate_name}}</option>
                                            @endforeach
                                        </select>
									</div>
									<div class="form-group" >
